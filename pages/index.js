              ...
              <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
                <div className="text-center">
                  ...
                  <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                    Restaurants serve one dish at a time. It's unknown to
                    customers and can change at any time. Blynd invites you to
                    experience local cuisine without the hassle.
                  </p>
                </div>

                <form
                  onSubmit={notifySubscriber}
          ...
          <div className="relative bg-white py-16 sm:py-24 lg:py-32">
            <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
              ...
              <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
                Help us by submitting and upvoting restaurants you want to see
                on the platform. If the restaurant you request joins Blynd, your
                first meal is on us!
              </p>
            </div>
            ...
            <div className="bg-gray-100 rounded-lg p-6 flex items-center sm:p-10">
              <div className="max-w-sm mx-auto">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  The latest restaurant reviews, recommendations, and curated
                  menus, sent to your inbox weekly.
                </p>
                <form
                  onSubmit={newsletterSubsctiber}
            ...
            <div className="mt-6 relative py-12 px-6 flex items-center sm:py-16 sm:px-10 lg:mt-0">
              ...
              <div className="relative max-w-sm mx-auto text-center">
                ...
                <p className="mt-2 text-gray-200">
                  Did you sign up to the newsletter? Subscribers get priority
                  access to the launch.{' '}
                  <a
                    target="_blank"
                    href="https://blog.eatblynd.com"
